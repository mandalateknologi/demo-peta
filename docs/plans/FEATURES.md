...
| FEAT-014 | UI Contrast Enhancement                   | Enhance visual contrast for sidebar, running text ticker, selected province highlight, and map markers/clusters using combined approach (darker bg, accent borders, higher opacity, shadows) | Medium   | Approved    | —                          | 2026-04-08 |
